...
train_dataset =   torchvision.datasets.CIFAR-10('/files/', train=True, download=True, transform=transforms_list)

train_data , val_data = torch.utils.data.random_split(train_dataset, [45000, 5000],generator=torch.Generator().manual_seed(42))
...
test_loader = torch.utils.data.DataLoader(
  torchvision.datasets.CIFAR-10('files/', train=False, download=True , transform = transforms_list),
