# -*- coding: utf-8 -*-
"""Googlenet_final_CIFAR_swati.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FF8hp1BwJ-nxd5R_Cu_fYA03dQlOQCDH
"""
...
transforms_list =   transform=torchvision.transforms.Compose([                
                                                              ...
                                                              torchvision.transforms.Normalize((0.50,), (0.50,)),  
                                                        ])

batch_size = 256

train_dataset =   torchvision.datasets.CIFAR10('/files/', train=True, download=True, transform=transforms_list)
test_dataset = torchvision.datasets.CIFAR10('/files/', train=False, download=True, transform=transform)
